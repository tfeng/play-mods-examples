 ...
 */
@Component("kafkaServerStartable")
public class KafkaServerStartable implements Startable {

  private static final ALogger LOG = Logger.of(KafkaServerStartable.class);

  private ServerCnxnFactory cnxnFactory;

  private File kafkaDirectory;

  private kafka.server.KafkaServerStartable kafkaServer;
  ...
  public void onStart() throws Throwable {
    ...
    kafkaServer = new kafka.server.KafkaServerStartable(kafkaConfig);
    kafkaServer.startup();

    // Create Kafka topic.
    int port = Integer.parseInt(zkProperties.getProperty("clientPort"));
    KafkaUtils.createTopic("localhost:" + port, kafkaTopic, 1, 1);
  }
